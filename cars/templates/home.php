  	...
  	<div class="content">
        ...
        <section class='carBookingForm rel' style="background-image:url('<?php echo get_field('banner_background', 'options'); ?>');">
            ...
            <div class='grid-container formMedWidth'>
                <div class='grid-x grid-margin-x align-middle formCols formHome'>
                    <div class='small-12 medium-12 large-5 cell'>
                        <div class='whiteBox'>
                            ...
                            <!-- <iframe src="https://book.cartrawler.com/?clientID=540416" width="350" height="450" marginwidth="0" marginheight="0" frameborder="0" scrolling="no"></iframe> -->
        ...
        <section class='logoSlider homeSlider mar50'>
                            ...
                            <?php if( have_rows('desintations_cats','options')):  $i = 1; ?>
                                <?php while ( have_rows('desintations_cats','options')) : the_row(); ?>
                                    <div class='small-6 medium-6 large-3 cell'>
                                        <img class="countryimg img_<?php echo $i; ?>" src="<?php echo get_sub_field('cat_img'); ?>">
                                        <h4 class='marT30 marB20'><?php echo get_sub_field('title'); ?></h4>
                ...
                <div class='grid-x marB30'>
                    <div class='large-12 cell'>
                        <div class='titleLinkwrap'>
                            ...
                            <a class='blue blogLink' href='<?php echo get_site_url(); ?>/blog'><span class='underline'>View all blogs</span> <span class="material-icons">navigate_next</span></a>
                        </div>
                    </div>
                </div>
                <div class='grid-x mar30'>
